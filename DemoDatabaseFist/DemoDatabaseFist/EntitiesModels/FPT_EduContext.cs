...
{
    public partial class FPT_EduContext : DbContext
    {
        public FPT_EduContext()
        {
        }

        public FPT_EduContext(DbContextOptions<FPT_EduContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("server =(local); database = FPT_Edu;uid=sa;pwd=1;");
            }
        }
